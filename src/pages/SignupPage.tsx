    ...
    >
      ...
      <div className="w-[92%] sm:w-[440px] h-[640px] relative mx-auto bg-black/70 rounded-xl outline outline-1 outline-neutral-600 backdrop-blur-[30px] my-4 sm:my-8 max-w-[440px]">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-[40px] flex items-center gap-3">
          ...
          <span className="text-white text-3xl font-power-grotesk font-light crypto-chat-text">Crypto Chat</span>
        </div>
            ...
            >
              <div className="absolute left-1/2 -translate-x-1/2 top-[80px] flex flex-col items-center w-[85%] sm:w-[380px] max-w-[380px]">
                ...
                <div className="mt-2 text-zinc-500 text-base sm:text-lg font-normal font-['Sequel Sans Display'] text-center hidden sm:block">
                  Tenha a IA cripto mais inteligente do mercado pra te ajudar.
                </div>
              </div>
              ...
              <form onSubmit={handleStepOne} className="w-full">
                ...
                <div className="w-[85%] sm:w-[380px] max-w-[380px] h-14 px-4 absolute left-1/2 -translate-x-1/2 top-[350px] flex items-center gap-2.5 rounded-lg outline outline-1 outline-neutral-400 focus-within:outline-yellow-400 transition-colors">
                  <img src={iconSenha} alt="Senha Icon" className="w-7 h-7" />
                  <input
                    type="password"
                ...
                {error && (
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="absolute top-[415px] left-1/2 -translate-x-1/2 w-[85%] sm:w-[380px] max-w-[380px] text-center text-red-500 text-xs font-['Helvetica']"
                  >
                    {error}
                  </motion.div>
                )}
                ...
                <motion.button
                  ...
                  disabled={loading}
                  className={`w-[85%] sm:w-[380px] max-w-[380px] h-14 absolute top-[475px] left-1/2 -translate-x-1/2 bg-gradient-to-b from-yellow-300 via-yellow-400 to-yellow-200 rounded-lg flex items-center justify-center ${loading ? 'opacity-70 cursor-not-allowed' : 'hover:from-yellow-200 hover:to-yellow-400'}`}
                >
              ...
              {/* Divider */}
              <div className="flex items-center justify-center absolute top-[545px] left-1/2 -translate-x-1/2 w-[85%] sm:w-[380px] max-w-[380px]">
              ...
              <motion.button
                ...
                disabled={loading}
                className={`w-[85%] sm:w-[380px] max-w-[380px] h-14 absolute top-[590px] left-1/2 -translate-x-1/2 rounded-lg outline outline-1 outline-neutral-400 flex items-center justify-center ${loading ? 'opacity-30' : 'opacity-70'} hover:opacity-100 transition-all`}
              >
              ...
              {/* Já tem conta */}
              <div className="absolute left-1/2 -translate-x-1/2 top-[660px] text-base font-['Sequel Sans Display'] text-center px-4 sm:px-0 w-full whitespace-nowrap">
